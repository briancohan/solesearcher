...
export default function About() {
  return (
    <div className='flex flex-col gap-4'>
      ...
      <h2 className='text-2xl font-semibold leading-6 text-sole-tan' id='help-modal-title'>
      ...
      <h2 className='text-2xl font-semibold leading-6 text-sole-tan'>Instructions</h2>
      ...
      <h2 className='text-2xl font-semibold leading-6 text-sole-tan'>Credits</h2>
